...
import userOneImg from "../public/jagdamba.png";
import userTwoImg from "../public/jagdamba.png";
import userThreeImg from "../public/jagdamba.png";
...
function Mark(props) {
	return (
		<>
			{" "}
			<mark className="text-yellow-500 bg-gray-800 rounded-md ring-indigo-100 ring-4 ">
				{props.children}
			</mark>{" "}
		</>
	);
